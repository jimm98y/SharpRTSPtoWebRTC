namespace SharpJaad.AAC.Ps
{
    public class Filterbank
    {
        ...
        public Filterbank(int numTimeSlotsRate)
        {
            ...
            _frameLen = numTimeSlotsRate;

            _work = new float[(_frameLen + 12), 2];

            _buffer = new float[5, _frameLen, 2];
        ...
        public void HybridAnalysis(float[,,] X, float[,,] X_hybrid, bool use34, int numTimeSlotsRate)
        {
            ...
            int[] resolution = use34 ? _resolution34 : _resolution20;
            ...
            for (band = 0; band < qmf_bands; band++)
            {
                ...
                /* add new samples */
                for (n = 0; n < _frameLen; n++)
                {
                    _work[12 + n, 0] = X[n + 6 /*delay*/, band, 0];
                    _work[12 + n, 0] = X[n + 6 /*delay*/, band, 0];
                }
                ...
                switch (resolution[band])
                {
                    case 2:
                        ...
                        ChannelFilter2(_frameLen, PSTables.p2_13_20, _work, _temp);
                        break;
                    case 4:
                        /* Type A complex filter, Q[p] = 4 */
                        ChannelFilter4(_frameLen, PSTables.p4_13_34, _work, _temp);
                        break;
                    case 8:
                        /* Type A complex filter, Q[p] = 8 */
                        ChannelFilter8(_frameLen, use34 ? PSTables.p8_13_34 : PSTables.p8_13_20,
                            _work, _temp);
                        break;
                    case 12:
                        /* Type A complex filter, Q[p] = 12 */
                        ChannelFilter12(_frameLen, PSTables.p12_13_34, _work, _temp);
                        break;
                }
                ...
                for (n = 0; n < _frameLen; n++)
                {
                    ...
                    {
                        X_hybrid[n, offset + k, 0] = _temp[n, k, 0];
                        X_hybrid[n, offset + k, 1] = _temp[n, k, 1];
                    }
                }
